...
// lib modules
const pstorage = require('./storage');
...
module.exports = class Persistence {
    ...
    persistNewState(newDocs, callback = () => {}) {
        ...
        pstorage
            .appendFile(self.filename, toPersist, 'utf8')
            .then(() => callback(null))
            .catch(callback);
    }
            ...
            [
                cb => {
                    pstorage
                        ...
                        .then(() => pstorage.ensureDatafileIntegrity(self.filename))
                        .then(() => pstorage.readFile(self.filename, 'utf8'))
                        .then(rawData => {
